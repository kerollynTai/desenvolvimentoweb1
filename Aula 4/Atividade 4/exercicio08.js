...
function atualizarCurso(){
    ...
    const nome = readline.question("Informe o nome atualizado do curso: ");
    const carga_horaria = readline.question("Informe a carga horária atualizada do curso: ");
 
    const id = readline.question("Informe o id do curso que terá os dados atualizado: ");
